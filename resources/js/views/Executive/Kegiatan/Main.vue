        ...
        <div class="e-topbar transparent">
            <b-row>
                <b-col cols="6 d-flex align-items-center">
                    <h4><router-link to="/executive"><ph-caret-left class="phospor" /></router-link> <span class="semibold ml-3">Kegiatan</span></h4>
                </b-col>
                <b-col cols="6 pt-2">
                    <b-row>
                            ...
                            <div class="e-box">
                                ...
                                <perfect-scrollbar class="e-box-list e-box-list-lg">
                                    <b-row>
                                        ...
                                        <b-col cols="12 pt-1">
                                            Kanit Binmas Polsek Sangkuriang Aiptu Khaerul W. laksanakan Kunjungan ke tukang Ojek.
                                        </b-col>
                                    ...
                                    <b-row>
                                        ...
                                        <b-col cols="12 pt-1">
                                            Edukasi Peningkatan Disiplin Kesehatan
                                        </b-col>
                                        <b-col cols="12"><hr/></b-col>
                                    </b-row>
                                    <b-row>
                            ...
                            <b-row>
                                <b-col cols="12">
                                    <div class="e-box">
                                        <b-row>
                                            <b-col cols="8">
                                                <h4 class="font-weight-bold d-inline-block mb-4">Per jenis laporan <small>(30 Maret 2021)</small></h4>
                                            </b-col>
                                            ...
                                            <b-col cols="6 p-0 h-100">
                                                ...
                                                <b-row class="mb-3">
                                                    <b-col cols="8 d-flex align-items-center">  
                                                        <div class="e-pill e-pill-primary-1"></div>
                                                        Turjawali Ditsamapta
                                                    </b-col>
                                                    <b-col cols="3 text-center"><div class="e-bg-primary p-1 px-3 rounded d-inline-block">1</div></b-col>
                                                </b-row>
                                                <b-row class="mb-3">
                                                    <b-col cols="8 d-flex align-items-center">  
                                                        <div class="e-pill e-pill-primary-2"></div>
                                                        Turjawali Ditlantas
                                                    </b-col>
                                                    <b-col cols="3 text-center"><div class="e-bg-primary p-1 px-3 rounded d-inline-block">2</div></b-col>
                                                </b-row>
                                                <b-row class="mb-3">
                                                    <b-col cols="8 d-flex align-items-center">  
                                                        <div class="e-pill e-pill-primary-3"></div>
                                                        PPKM Mikro
                                                    </b-col>
                                                    <b-col cols="3 text-center"><div class="e-bg-primary p-1 px-3 rounded d-inline-block">3</div></b-col>
                                                </b-row>
                                                <b-row class="mb-3">
                                                    <b-col cols="8 d-flex align-items-center">  
                                                        <div class="e-pill e-pill-primary-4"></div>
                                                        Bhabinkamtibmas
                                                    </b-col>
                                                    <b-col cols="3 text-center"><div class="e-bg-primary p-1 px-3 rounded d-inline-block">6</div></b-col>
                                                </b-row>
                                            </b-col>
                                        </b-row>
                                    </div>
                            ...
                            <div class="e-box">
                                ...
                                <perfect-scrollbar class="e-box-list e-box-list-sm">
                                    <b-row class="mb-3">
                                        ...
                                        <b-col cols="3 text-center"><div class="e-bg-primary p-2 rounded d-inline-block">45</div></b-col>
                                    </b-row>
                                    <b-row class="mb-3">
                                        <b-col cols="3 text-center">
                                            <div class="e-img-circle">
                                        ...
                                        <b-col cols="3 text-center"><div class="e-bg-primary p-2 rounded d-inline-block">32</div></b-col>
                                    </b-row>
                                    <b-row class="mb-3">
                                        <b-col cols="3 text-center">
                                            <div class="e-img-circle">
                                        ...
                                        <b-col cols="3 text-center"><div class="e-bg-primary p-2 rounded d-inline-block">24</div></b-col>
                                    </b-row>
                                </perfect-scrollbar>
                            </div>
                        </b-col>
