  	...
  	<div>
    	<b-row>
  		...
  		<b-row>
  			<b-col cols="12">
	  			<b-tabs pills>
			    	<b-tab title="PENDAPATAN DANSOS">
			    		<PendapatanDansos ref="pendapatanDansos" />
			    	</b-tab>
			    	<b-tab title="GIAT DANSOS">
			    		<Dansos ref="dansos" />
			    	</b-tab>
			  	</b-tabs>
  			</b-col>
...
<script>
	...
	import Dansos from './Dana/Dansos'
	import PendapatanDansos from './Dana/PendapatanDansos'
	...
	export default {
		...
		methods: {
			...
			refreshTable () {
				...
				this.$refs.pendapatanDansos.fetchData(params)
				this.$refs.dansos.fetchData(params)
			}
		},
		mounted() {
		    this.fetchKabupaten()
