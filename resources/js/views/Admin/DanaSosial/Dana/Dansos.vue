		...
		<div class="position-relative">
			<b-table responsive
		        ...
		        <template slot="foto" slot-scope="data">
		          	<b-img :src="data.item.foto" v-if="data.item.foto != null" width="250"/>
		        </template>
		    </b-table>
	...
	export default {
		...
		data () {
			return {
				...
				tableColumns: [
					{ key: 'index', label: 'No' },
					{ key: 'kepada', label: 'Kepada', sortable: false },
					{ key: 'kegunaan', label: 'Kegunaan', sortable: false },
		...
		methods: {
			...
			providerDansos (ctx) {
				...
				return axios.get('report/dansos/', { params: payload })
