	...
	<div>
		...
		<div class="position-relative">
			<b-table responsive
	               ref="tabelDansos"
	               :busy.sync="isBusy"
	               :items="providerPendapatanDansos"
	               :fields="tableColumns"
	...
	export default {
		...
		data () {
			return {
				...
				tableColumns: [
					...
					{ key: 'asal', label: 'Asal', sortable: false },
		...
		methods: {
			...
			providerPendapatanDansos (ctx) {
				...
				return axios.get('report/pendapatan-dansos/', { params: payload })
